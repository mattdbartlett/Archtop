...
TEST(TestArc, TestCollissionHemicircle2WithRay) {
    Arc arc(10, 270, 90, pt(0,0));
...
TEST(TestArc, TestCollissionQuarterCircle) {
...
TEST(TestArc, TestCollissionQuarterCircleWithRay) {
    Arc arc(10, 90, 180, pt(0,0));
